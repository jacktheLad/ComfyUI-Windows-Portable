...
https://github.com/jacktheLad/ComfyUI-Windows-Portable/releases[release page].
** Or you can download them directly:
*** https://github.com/jacktheLad/ComfyUI-Windows-Portable/releases/latest/download/ComfyUI_Windows_portable_cu128.7z.001[ComfyUI_Windows_portable_cu128.7z.001]
*** https://github.com/jacktheLad/ComfyUI-Windows-Portable/releases/latest/download/ComfyUI_Windows_portable_cu128.7z.002[ComfyUI_Windows_portable_cu128.7z.002]
*** https://github.com/jacktheLad/ComfyUI-Windows-Portable/releases/latest/download/models.zip.001[models.zip.001] (If you are upgrading from a previous release, you don't need this file.)
...
image:https://github.com/jacktheLad/ComfyUI-Windows-Portable/actions/workflows/build.yml/badge.svg["GitHub Workflow Status",link="https://github.com/jacktheLad/ComfyUI-Windows-Portable/actions/workflows/build.yml"]
...
https://github.com/jacktheLad/ComfyUI-WinPortable-XPU/actions/workflows/build.yml[this].
